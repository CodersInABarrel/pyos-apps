Dowloading PyOS apps, apps can be dowloaded from the built in PyOS app installer, or you can dowload the .py files directly and drag and drop them into the /APPS folder
